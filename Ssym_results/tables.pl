...
system ("korpm  ../SsymN.txt -r 5 --dir ../Ssym --score_file ../pot/korp6Dv1.bin -o KORPM_Pucci2018N.txt --dexp --rsa --class  > log");
system ("../scripts/Mstat.pl KORPM_Pucci2018N.txt 10 11 2 > NKORPM.Mlog");
system ("../scripts/confusion.pl  KORPM_Pucci2018N.txt 10 11 100 >  KORPM_Pucci2018N_prc.txt");
system ("korpm  ../SsymR.txt -r 5 --dir ../Ssym --score_file ../pot/korp6Dv1.bin -o KORPM_Pucci2018revN.txt --dexp --rsa --class > log");
system ("../scripts/Mstat.pl KORPM_Pucci2018revN.txt 10 11 2 > RKORPM.Mlog");
system ("../scripts/confusion.pl  KORPM_Pucci2018revN.txt 10 11 100 >  KORPM_Pucci2018revN_prc.txt");
system ("korpm ../SsymD.txt -r 5 --dir ../Ssym --score_file ../pot/korp6Dv1.bin -o KORPM_Pucci2018dirN.txt --dexp --rsa --class > log");
system ("../scripts/Mstat.pl KORPM_Pucci2018dirN.txt 10 11 2 > DKORPM.Mlog");
system ("../scripts/confusion.pl  KORPM_Pucci2018dirN.txt 10 11 100 >  KORPM_Pucci2018dirN_prc.txt");
...
foreach (@list_th) {
 ...
 $cmd="../scripts/confusion.pl  $_\_Pucci2018N_th8.txt 3 4 100 >  $_\_Pucci2018N_th8_prc.txt"; system ($cmd); 
 $cmd="../scripts/Mstat.pl  $_\_Pucci2018dirN_th8.txt 3 4 2 > D$_.Mlog\n"; system ($cmd);
 $cmd="../scripts/confusion.pl  $_\_Pucci2018dirN_th8.txt 3 4 100 >  $_\_Pucci2018dirN_th8_prc.txt"; system ($cmd); 
 $cmd="../scripts/Mstat.pl  $_\_Pucci2018revN_th8.txt 3 4 2 > R$_.Mlog\n"; system ($cmd);
 $cmd="../scripts/confusion.pl  $_\_Pucci2018revN_th8.txt 3 4 100 >  $_\_Pucci2018revN_th8_prc.txt"; system ($cmd); 
...
foreach (@list) {
 ...
 $cmd="../scripts/confusion.pl  $_\_Pucci2018N.txt 3 4 100 >  $_\_Pucci2018N_prc.txt"; system ($cmd);
 $cmd="../scripts/Mstat.pl  $_\_Pucci2018dirN.txt 3 4 2 > D$_.Mlog\n"; system ($cmd);
 $cmd="../scripts/confusion.pl  $_\_Pucci2018dirN.txt 3 4 100 >  $_\_Pucci2018dirN_prc.txt"; system ($cmd); 
 $cmd="../scripts/Mstat.pl  $_\_Pucci2018revN.txt 3 4 2 > R$_.Mlog\n"; system ($cmd);
 $cmd="../scripts/confusion.pl  $_\_Pucci2018revN.txt 3 4 100 >  $_\_Pucci2018revN_prc.txt"; system ($cmd); 
