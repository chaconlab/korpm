...
#include <cmdl/SwitchArg.h>
#include <cmdl/UnlabeledValueArg.h>
#include <cmdl/UnlabeledMultiArg.h>

#include <cmdl/XorHandler.h>
#include <cmdl/HelpVisitor.h>
#include <cmdl/VersionVisitor.h>
#include <cmdl/IgnoreRestVisitor.h>

#include <cmdl/CmdLineOutput.h>
#include <cmdl/StdOutput.h>
...
inline void CmdLine::parse(int argc, char** argv)
{
	try {
        ...
        std::string current="not_set_yet";

        // if (current!=_progName)
	//_progName = argv[0];
